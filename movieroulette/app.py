...
# def home():
#     cur = conn.cursor()
#     #Getting 8 random rows from Attributes
#     tenrand = '''select * from Attributes order by random() limit 8;'''
#     cur.execute(tenrand)
#     punks = list(cur.fetchall())
#     length = len(punks)

#     # Preload random id from table Attributes
...
#     # If user just pressed, e.g., 'Random' or 'Home'.
#     length = len(punks)
